...
?>
        ...
        <div class="py-12 bg-black border-y border-zinc-800 overflow-hidden relative">
            ...
            <div class="flex animate-scroll w-max gap-8 md:gap-16 items-center">
                <?php foreach ($scrolling_tech as $index => $tech) : ?>
                    <span class="text-2xl md:text-4xl font-mono font-bold text-zinc-800 hover:text-brand-500 transition-colors cursor-default uppercase whitespace-nowrap">
